        ...
        <div class="container text-white">
            <div class="row">
                ...
                <div class="col-sm-4 col-12 align-self-center box-1 text-center">
                    <a class="navbar-brand" href="index"><img style="height: 150px; width: 100%;" src="assets/images/logo.svg" alt="logo"></a>
                </div> 
    ...
    <section class="section-1">
        <div class="jumbotron d-flex align-items-center">
            ...
            <div class="container-fluid content">
                <h1 data-aos="fade-right" data-aos-delay="400">WELCOME TO Meditech Corporation </h1>
                <h2 data-aos="fade-left" data-aos-delay="400">An engineering company that specializes in selling machinery from manufacturers throughout the world
