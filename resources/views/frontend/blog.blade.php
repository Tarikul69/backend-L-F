        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12 col-12 box-1"  data-aos="fade-right" data-aos-delay="300">
                    <figure class="figure">
                        <a href="blog_single.html"><img src="assets/images/blog-1.jpg" class="figure-img img-fluid" alt="blog"></a>
                        <figcaption class="figure-caption">
                            <h2><a href="blog_single.html">Beautiful girl holding her camera in neck for a photo shoot</a></h2>
                ...
                <div class="col-lg-8 col-sm-12 col-12"  data-aos="fade-left" data-aos-delay="300">
                    <div class="row">
                        <div class="col-sm-6 col-12 box-2">
                            <figure class="figure">
                                <a href="blog_single.html"><img src="assets/images/blog-2.jpg" class="figure-img img-fluid" alt="blog"></a>
                            </figure>
                        </div>
                        <div class="col-sm-6 col-12 box-3">
                            <h4><a href="blog_single.html">Girl working seriously on laptop in office hours</a></h4>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-12 box-4">
                            <figure class="figure">
                                <a href="blog_single.html"><img src="assets/images/blog-3.jpg" class="figure-img img-fluid" alt="blog"></a>
                            </figure>
                        </div>
    ...
    <section class="section-7">
        ...
        <footer class="page-footer font-small stylish-color-dark">
            ...
            <div class="footer-copyright text-center">
                <div class="gradient"></div>
                <p>© <?php echo date("Y") ?>, All Rights reserved. more theme, designed by<a href="https://www.template.net/editable/websites/html5"> tEMPLATE.net</a></p>
            </div>
            <!-- Copyright -->
