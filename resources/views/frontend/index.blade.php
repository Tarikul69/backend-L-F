                ...
                <div class="col-lg-4 col-sm-12 col-12 box-1">
                    <div class="row box" data-aos="fade-left" data-aos-delay="300">
                        ...
                        <div class="col-lg-10 col-sm-12">
                            ...
                            <p><a href="services"><img src="assets/images/plus.png" alt="plus"></a></p>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row m-0">
                <div class="col-lg-5 col-md-12 p-0" data-aos="fade-right" data-aos-delay="300">
                    ...
                    <ul>
                        <li><a href="services"><i class="fa fa-angle-right" aria-hidden="true"></i>1.Web Designing</a> </li>
                        <li><a href="services"><i class="fa fa-angle-right" aria-hidden="true"></i>2.Web Designing</a></li>
                        <li><a href="services"><i class="fa fa-angle-right" aria-hidden="true"></i>3.Web Designing</a></li>
                        <li><a href="services"><i class="fa fa-angle-right" aria-hidden="true"></i>4.Web Designing</a></li>
                        <li><a href="services"><i class="fa fa-angle-right" aria-hidden="true"></i>5.Web Designing</a></li>
                        <li><a href="services"><i class="fa fa-angle-right" aria-hidden="true"></i>6.Web Designing</a></li>
                    </ul>
                </div>
                <div class="col-lg-7 col-md-12 p-0" data-aos="fade-left" data-aos-delay="300">
                    <figure>
                        <img class="inner-img" src="assets/images/services-bg2.jpg" alt="services">
                        <img class="out-sideimg" src="assets/images/services-bg.jpg" alt="services">
                    </figure>
                </div>
            </div>
        </div>
